package com.article.project.windowmanager
...
import com.article.project.windowmanager.databinding.ActivityWindowManagerMainBinding
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.flow.collect
import kotlinx.coroutines.launch

class WindowManagerMainActivity : AppCompatActivity() {
    private lateinit var windowInfoRepository: WindowInfoRepository
    private lateinit var binding: ActivityWindowManagerMainBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityWindowManagerMainBinding.inflate(layoutInflater)
